...
public class Commodity {
	...
	public Commodity(int pid, String pname, double price, String pimage, String pdescripe, int sale_number, int shop_id,
			int category_id, String date, double inventory) {
		super();
		this.pid = pid;
		this.pname = pname;
		this.price = price;
